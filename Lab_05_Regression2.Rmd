...
5. Use the `predict` function to generate a plot of predicted vs observed per capita CO2 emissions. Make sure to include a 1:1 line. Describe how the model performed based on this graph.
