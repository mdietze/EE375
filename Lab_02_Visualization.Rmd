...
![](img/clean_environment.png){width=50px}

Now that your environment is clean, we will load in the data.

We'll be using the same data that we used in Lab 1. However, it is recommended that you make sure the data file in to the same folder as Lab 2. Then we can run the code:
...
## ★ Questions (4)
4. **Using the frog data, show just the spots column as characters**
...
## ★ Questions (5)
5.	**Using the frog data set and either base or dplyr functions:** 
...
## ★ Questions (6-7)
6. **Use apply to calculate the across-population standard deviations in the numbers of frogs and tadpoles**. Reminder: Each row of this dataset represents a unique population.
7. **Use dplyr to calculate the daily mean air temperature**
